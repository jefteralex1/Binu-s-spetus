...
def home():
    return render_template('index.html') #Define a função 'home' que é chamada quando a rota '/' é acessada. Esta função renderiza e retorna o template 'index.html'.

@home_route.route('/bino')
def site_principal():
    return render_template('bino.html')

@home_route.route('/churrascometro.html')
def churrascometro():
    return render_template('churrascometro.html')
    
@home_route.route ('/cardápio.html')
def cardapio():
    return render_template('cardápio.html')

@home_route.route ('/kits.html')
def kits():
    return render_template('kits.html')

@home_route.route('/bino.html')
def cardapiobio():
    return render_template('bino.html')

@home_route.route('/churrascometro.html')
def cardapiochurrascometro():
    return render_template('churrascometro.html')

@home_route.route('/Churrascometro/src/cardápio.html')
def churrascometrocardapio():
    return render_template('cardápio.html')

@home_route.route('/Churrascometro/src/bino.html')
def churrascometrobino():
    return render_template('bino.html')
